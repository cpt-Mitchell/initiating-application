          ...
          request
            ...
            .then(res => {
              if (res.data) {
                ...
                that.yearMonth = res.data.data.readMeterDate || ''
                // that.getPreMonth()
              }
            })
            ...
            .then(res => {
              if (res.data.success) {
                ...
                Dialog.confirm({
                  title: '提示',
                  message: '是否进入下一个表',
                  confirmButtonText: '下一个表'
                })
                  .then(() => {
                    let params = res.data.data || {}
                    request
                      .post(API.readingNext, params)
                      .then(res => {
                        this.form = {}
                        this.fileList = []
                        if (res.data) {
                          this.form = res.data.data || {}
                          this.yearMonth = res.data.data.readMeterDate || ''
                          // this.getPreMonth()
                        }
                      })
                      .catch(err => (this.isLoading = false))
